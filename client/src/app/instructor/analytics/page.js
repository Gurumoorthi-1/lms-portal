      ...
      <div className="space-y-10 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           {[
             ...
             { label: 'Pass Rate (Threshold 70%)', value: data.passRate, icon: Shield, color: 'text-emerald-500' },
             { label: 'Engagement Score', value: data.engagementScore, icon: TrendingUp, color: 'text-purple-500' },
